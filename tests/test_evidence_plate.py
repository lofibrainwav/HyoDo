...
def test_atoms_are_exact_artifact_bound_and_authority_free() -> None:
    atoms = extract_evidence_atoms(
        {"exact_artifact_sha": "a" * 40, "source": "fixture", "freshness": "fresh", "authority": "human", "score": 1}
    )
    assert len(atoms) == 1
...
def test_plate_is_observed_without_becoming_a_decision() -> None:
    plate = make_evidence_plate(
        {"exact_artifact_sha": "b" * 64, "observed_at": "2026-09-18T00:00:00Z", "provenance": "fixture"},
        "truth",
    )
