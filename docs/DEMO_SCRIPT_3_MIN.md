...
**Target version:** see `VERSION` (SSOT; do not hardcode). Verify the current
public PyPI release before making a version claim.
...
- On `main`, clean worktree (`git status` clean), and use the matching release
