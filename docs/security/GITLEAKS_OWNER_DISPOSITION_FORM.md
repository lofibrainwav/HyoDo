...
| --- | --- | --- | --- | --- |
| 1 | `aws-access-token` | `tests/test_inspect.py:29` | `SYNTHETIC` | Owner-authorized test fixture classification |
| 2 | `aws-access-token` | `tests/test_observability_contracts.py:45` | `SYNTHETIC` | Owner-authorized test fixture classification |
| 3 | `aws-access-token` | `tests/test_observability_contracts.py:49` | `SYNTHETIC` | Owner-authorized test fixture classification |
| 4 | `aws-access-token` | `tests/test_observability_contracts.py:62` | `SYNTHETIC` | Owner-authorized test fixture classification |
| 5 | `aws-access-token` | `tests/test_observability_contracts.py:66` | `SYNTHETIC` | Owner-authorized test fixture classification |
| 6 | `aws-access-token` | `tests/test_mcp_stdio.py:109` | `SYNTHETIC` | Owner-authorized test fixture classification |
| 7 | `generic-api-key` | `hyodo/cli/main.py:350` | `SYNTHETIC` | Owner-authorized non-secret identifier classification |
| 8 | `aws-access-token` | `tests/test_safe_json.py:22` | `SYNTHETIC` | Owner-authorized test fixture classification |
...
| 12 | `generic-api-key` | `afo_core/tests/test_api_wallet.py:41` | `SYNTHETIC` | Owner-authorized historical test fixture classification |
| 13 | `generic-api-key` | `afo_core/tests/infrastructure/test_messaging.py:115` | `SYNTHETIC` | Owner-authorized historical test fixture classification |
