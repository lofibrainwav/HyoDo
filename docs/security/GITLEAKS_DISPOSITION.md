...
| ---: | --- | --- | --- | ---: | --- | --- |
| 1 | `aws-access-token` | `tests/test_inspect.py` | `ca18cf43cbfd656a36783aa84c3b60be7ef95096` | 29 | Test fixture candidate | `PENDING_OWNER` |
| 2 | `aws-access-token` | `tests/test_observability_contracts.py` | `caa88250b5786689667d936e3e375ace1c0f5a57` | 45 | Test fixture candidate | `PENDING_OWNER` |
| 3 | `aws-access-token` | `tests/test_observability_contracts.py` | `caa88250b5786689667d936e3e375ace1c0f5a57` | 49 | Test fixture candidate | `PENDING_OWNER` |
| 4 | `aws-access-token` | `tests/test_observability_contracts.py` | `caa88250b5786689667d936e3e375ace1c0f5a57` | 62 | Test fixture candidate | `PENDING_OWNER` |
| 5 | `aws-access-token` | `tests/test_observability_contracts.py` | `caa88250b5786689667d936e3e375ace1c0f5a57` | 66 | Test fixture candidate | `PENDING_OWNER` |
| 6 | `aws-access-token` | `tests/test_mcp_stdio.py` | `931be769b8d0f526b15af977d4a8bc6fb7611d56` | 109 | Test fixture candidate | `PENDING_OWNER` |
| 7 | `generic-api-key` | `hyodo/cli/main.py` | `e7c6ba7c3a83a1aedcbde65fc72758a744138d96` | 350 | Likely identifier false positive; owner confirmation required | `PENDING_OWNER` |
| 8 | `aws-access-token` | `tests/test_safe_json.py` | `d8c5df139a63aaacf1cb82fe63c72683dad6b40e` | 22 | Test fixture candidate | `PENDING_OWNER` |
...
| 12 | `generic-api-key` | `afo_core/tests/test_api_wallet.py` | `f897f82253862ca6b2e27ba8e78cc17014205dfa` | 41 | Historical test candidate; validity unknown | `PENDING_OWNER` |
| 13 | `generic-api-key` | `afo_core/tests/infrastructure/test_messaging.py` | `f897f82253862ca6b2e27ba8e78cc17014205dfa` | 115 | Historical test candidate; validity unknown | `PENDING_OWNER` |
