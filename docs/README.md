...
Current public line: see root `VERSION` (3.1.6 Truth Patch: honest check/safe exit
...
| Doc | Purpose |
|-----|---------|
| [ANTHROPIC_PROOF.md](./ANTHROPIC_PROOF.md) | Claude-specific adapter map (not the lead story) |

## Historical (may be stale)

- Root [`SECURITY_PATCHES.md`](../SECURITY_PATCHES.md) — historical patch log; Dependabot is live inventory for extended tree.
