...
HyoDo **4.19.4** is the closed public baseline. Product capability and live host
observation remain separate evidence axes.

- Canonical source branch: **`main`**
- Latest public package: **4.19.4**
...
prerequisites for calling the HyoDo 4.19.4 public artifact released and verified.
